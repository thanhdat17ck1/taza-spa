...
<body>
        ...
        <div class="container">
            <div class="row">
              ...
              <h4>Spac<span>Dyna</span></h4>
                        ...
                        <a href="{{ route('home') }}"><img src="assets/images/tazagroup-logo.png" alt="" style="max-width: 8rem;"></a>
                        ...
                        <ul class="nav">
                            ...
                            {{-- <li class="scroll-to-section"><a href="#lienhe">Liên hệ</a></li> --}}
                            {{-- <li class="scroll-to-section"><a href="#portfolio">Portfolio</a></li>
              <li class="scroll-to-section"><a href="#blog">Blog</a></li> --}}

                            {{-- <li class="scroll-to-section"><a href="#contact">Message Us</a></li> --}}
                            <li class="scroll-to-section">
                                <div class="main-red-button"><a href="#contact">Liên hệ</a></div>
                            </li>
    ...
    <div id="services" class="our-blog section">
        <div class="container">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content overflow-auto" style="height: 35rem;">
                        <div class="modal-header" data-spy="scroll" data-target=".navbar" data-offset="50">
                        ...
                        <form action="{{ route('create') }}" method="post">
                            ...
                            <div class="modal-body overflow-auto">
                                <div class="form-group">
                                    <label for="exampleTextarea">Tiêu đề</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alias" class="form-control" placeholder="Tiêu đề" />
                                </div>
                            </div>
                    ...
                    <div class="left-image">
                        ...
                        @for ($i = 0; $i < 1; $i++)
                            <div class="inner-content">
                                <ul>
                                    <li><i class="fa fa-calendar"></i> {{ $Article[$i]['attributes']['created'] }}</li>
                                </ul>
                            ...
                            @for ($i = 0; $i <= 2; $i++)
                                <li>
                                    <div class="left-content align-self-center">
                                        <span><i class="fa fa-calendar"></i>{{ $Article[$i]['attributes']['created'] }}</span>
                                        <a href="{{ route('detail',['id'=> $Article[$i]['id']]) }}">
                                            <h4>{{ $Article[$i]['attributes']['title'] }}</h4>
                                        </a>
  ...
  <div id="lienhe" class="contact-us section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 align-self-center wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.25s">
                    <div class="section-heading">
                        <h2>LIÊN HỆ TAZA GROUP</h2>
                        <p>Địa chỉ: 14-16 Bình Lợi, Phường 13, Bình Thạnh, TP. HCM</p>
                        <div class="phone-info">
                            <h4>For any enquiry, Call Us: <span><i class="fa fa-phone"></i> <a
                                        href="#">1900 2664</a></span></h4>
                        </div>
                    </div>
                </div>
